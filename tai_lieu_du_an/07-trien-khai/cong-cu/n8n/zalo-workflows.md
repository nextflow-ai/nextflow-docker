    ...
    },
    {
      "parameters": {
        ...
        "body": {
          ...
          "overrideConfig": {
            "systemMessagePrompt": "Bạn là trợ lý chăm sóc khách hàng của NextFlow CRM trên Zalo. Intent được phát hiện: {{$json.intent}}. Thông tin khách hàng: {{$json.customer}}. Hãy trả lời ngắn gọn, thân thiện và chuyên nghiệp."
          }
        }
      },
      "name": "AI Processing",
...
Hôm qua bạn có hỏi về sản phẩm NextFlow CRM. Chúng tôi muốn biết bạn có cần thêm thông tin gì không?
...
Cảm ơn bạn đã quan tâm đến NextFlow CRM! 
...
const monitoringConfig = {
  healthCheck: {
    interval: '5m',
    endpoints: [
      'https://your-domain.com/webhook/zalo-webhook',
      'https://flowise.nextflow-crm.com/api/health'
    ]
  },
