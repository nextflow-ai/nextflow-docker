# NGUYÊN TẮC THIẾT KẾ UX/UI NextFlow CRM
...
#### 2.2.2. Giảm tải trọng nhận thức
...
1. **Design Reviews**: Sử dụng nguyên tắc để đánh giá thiết kế
...
### 6.5. NextFlow CRM Documentation
- [Tổng quan Thiết kế](./tong-quan-thiet-ke.md)
