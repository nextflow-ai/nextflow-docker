# SCHEMA MARKETING NextFlow CRM-AI
...
Schema Marketing của NextFlow CRM-AI định nghĩa cấu trúc dữ liệu cho quản lý các hoạt động marketing, chiến dịch, email marketing và automation.
