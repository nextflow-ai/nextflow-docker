# SCHEMA SẢN PHẨM NextFlow CRM-AI
...
Schema Sản phẩm của NextFlow CRM-AI định nghĩa cấu trúc dữ liệu cho quản lý sản phẩm, danh mục, kho hàng và giá cả trong hệ thống CRM.
